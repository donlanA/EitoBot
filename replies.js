...
function EitoReply(inputStr, guildFlag = false, userName = '') {
  ...
  let message = [
    ...
    {
      chack: ['早安'],
      text: ['早安，{userName}同學。一大早就看見醜陋的你們，真是令人沮喪啊。',
    ...
    {
      chack: ['午安'],
      text: ['午安，{userName}同學。如果你能改向別人搭話，我會很開心的。',
        '嗯，午安。',
        '不需要特地跟我說午安也沒關係哦。',
    ...
    {
      chack: ['我生日', '我的生日'],
      text:['生日快樂，{userName}同學。其實我對人類的生日沒有什麼感情，不過既然拓海同學要我說，那我就給你一個最誠懇的祝福吧。願你在新的一年裡，少一點愚蠢，多一點利用價值，至少別讓自己那副醜惡的樣子更礙眼了。',
